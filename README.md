...
7. Surrender, Save/Load Game Board: Players can concede games, save finished games for future replay, or load previously saved games, adding flexibility to the gaming experience.
...
1. Follow this detailed [IDEA tutorial](https://github.com/judasn/IntelliJ-IDEA-Tutorial) for installation and setup instructions. Afterwards, download the project and open it directly in IntelliJ IDEA.
...
"Forbidden Move" is an additional rule in "Human VS Human" and also "Human VS AI" mode. Click on the button("ForbiddenMove On" in "Human VS Human" mode, "Forbidden Move" in "Human VS AI" mode), then you will be restrict by rules according to the "Chinese Backgammon Competition Rules".  
Specification:  
