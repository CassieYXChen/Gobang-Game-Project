...
### Main Page & Functions
1. In the main page, start time, elapsed time, and move time limit are shown above. Friend List is shown on right hand side, 19x19 gameboard is shown on left hand side, chatbox is shown on right hand side. Other buttons are shown below.  
